...
import 'package:just_audio_example/Helpers/spotify_helper.dart';
...
class SaavnUrlHandler extends StatelessWidget {
  final String token;
  final String type;
  const SaavnUrlHandler({key, required this.token, required this.type});
...
class SpotifyUrlHandler extends StatelessWidget {
  final String id;
  final String type;
  const SpotifyUrlHandler({key, required this.id, required this.type});
...
class YtUrlHandler extends StatelessWidget {
  final String id;
  final String type;
  const YtUrlHandler({key, required this.id, required this.type});
...
class OfflinePlayHandler extends StatelessWidget {
  final String id;
  const OfflinePlayHandler({key, required this.id});
